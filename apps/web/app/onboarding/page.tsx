...
export default function OnboardingPage() {
      ...
      case "welcome":
        return (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 18, color: "#6b7280", maxWidth: 500, marginTop: 0, marginRight: "auto", marginBottom: 32, marginLeft: "auto" }}>
      ...
      case "personal":
        return (
          <div>
            ...
            <div style={{ display: "grid", gap: 16, maxWidth: 500, marginTop: 0, marginRight: "auto", marginBottom: 0, marginLeft: "auto" }}>
      ...
      case "join":
        return (
          <div>
            ...
            <div style={{ maxWidth: 400, marginTop: 0, marginRight: "auto", marginBottom: 0, marginLeft: "auto" }}>
              <div>
                <label style={{ display: "block", fontSize: 14, fontWeight: 500, color: "#374151", marginBottom: 4 }}>
                  Invite Code *
                </label>
  ...
  return (
  <main style={{ maxWidth: 800, marginTop: 0, marginRight: "auto", marginBottom: 0, marginLeft: "auto", padding: 24, minHeight: "80vh", display: "flex", alignItems: "center" }}>
      <div style={{ width: "100%" }}>
        {/* Progress indicator */}
